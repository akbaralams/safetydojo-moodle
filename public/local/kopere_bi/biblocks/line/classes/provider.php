...
class provider implements i_block_provider {
    ...
    public static function get_name() {
        return get_string("pluginname", "biblocks_line");
    }
    ...
    public static function get_description() {
        return get_string("pluginname_desc", "biblocks_line");
    }
    ...
    public function edit(dynamic_moodleform $form, $koperebielement) {
        ...
        $html = message::warning(get_string("line_sql_warning", "biblocks_line"));
        $form->add_html($html);
                    ...
                    "
{
    ...
    public function preview($koperebielement) {
        ...
        return $return . $OUTPUT->render_from_template("biblocks_line/preview", $data);
    }
