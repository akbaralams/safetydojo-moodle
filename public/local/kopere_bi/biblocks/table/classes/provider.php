...
class provider implements i_block_provider {
    ...
    public static function get_name() {
        return get_string("pluginname", "biblocks_table");
    }
    ...
    public static function get_description() {
        return get_string("pluginname_desc", "biblocks_table");
    }
    ...
    private function select_data(dynamic_moodleform $form, $koperebielement, $collkey) {
        ...
        $types = [
            [
                "key" => "none",
                "value" => get_string("table_renderer_none", "biblocks_table"),
            ], [
                "key" => "string",
                "value" => "...",
            ], [
                "key" => "number",
                "value" => get_string("table_renderer_number", "biblocks_table"),
            ], [
                "key" => "userfullname",
                "value" => get_string("table_renderer_userfullname", "biblocks_table"),
            ], [
                "key" => table_header_item::RENDERER_USERPHOTO,
                "value" => get_string("table_renderer_userphoto", "biblocks_table"),
            ], [
                "key" => table_header_item::RENDERER_VISIBLE,
                "value" => get_string("table_renderer_visible", "biblocks_table"),
            ], [
                "key" => table_header_item::RENDERER_STATUS,
                "value" => get_string("table_renderer_status", "biblocks_table"),
            ], [
                "key" => table_header_item::RENDERER_DATE,
                "value" => get_string("table_renderer_date", "biblocks_table"),
            ], [
                "key" => table_header_item::RENDERER_DATETIME,
                "value" => get_string("table_renderer_datetime", "biblocks_table"),
            ], [
                "key" => table_header_item::RENDERER_TIME,
                "value" => get_string("table_renderer_seconds", "biblocks_table"),
            ], [
                "key" => "translate",
                "value" => get_string("table_renderer_translate", "biblocks_table"),
            ], [
                "key" => table_header_item::RENDERER_FILESIZE,
                "value" => get_string("table_renderer_filesize", "biblocks_table"),
            ],
        ];
        ...
        $form->add_input(
            input_select::new_instance()
                ->set_title(get_string("table_renderer_title", "biblocks_table"))
        ...
        $PAGE->requires->js_call_amd("biblocks_table/table", "select", [$collkey, $changemustache]);
        ...
        $form->add_input(
            input_textarea::new_instance()
                ->set_title(get_string("table_renderer_mustache", "biblocks_table"))
    ...
    public function preview($koperebielement) {
        ...
        if (!isset($koperebielement->info_obj["column"])) {
            return message::danger(get_string("table_column_not_configured", "biblocks_table"));
        }
