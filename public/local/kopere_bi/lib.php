...
function local_kopere_bi_iplookup_find_location($ip) {
    ...
    // Pastikan semua property selalu ada.
    $dataip->countryCode = $dataip->countryCode ?? '';
    $dataip->lat         = $dataip->lat ?? 0;
    $dataip->lon         = $dataip->lon ?? 0;

    // Property yang dipakai Kopere BI.
